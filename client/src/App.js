...
function App() {
  const position = [37.42183, -122.08392];
  ...
  const fileJson = {
    features: [
      ...
      {
        geometry: {
          coordinates: [-122.0857667006183, 37.42156927867553, 50],
          type: "Point",
        },
        properties: {
          description:
      ...
      },
      {
        ...
        properties: {
          description: "Black line (10 pixels wide), height tracks terrain",
          name: "Relative",
